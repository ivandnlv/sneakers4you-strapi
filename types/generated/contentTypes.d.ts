...
export interface ApiSlideSlide extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slideId: Attribute.UID & Attribute.CustomField<'plugin::field-uuid.uuid'>;
...
export interface ApiSneakerSneaker extends Schema.CollectionType {
  ...
  attributes: {
    ...
    brand: Attribute.Enumeration<
      ['nike', 'adidas', 'jordan', 'reebok', 'vans', 'underarmor', 'puma']
    > &
      Attribute.Required;
    description: Attribute.Text;
    sneakerId: Attribute.UID & Attribute.CustomField<'plugin::field-uuid.uuid'>;
    sneakerImages: Attribute.Media;
